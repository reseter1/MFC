                            ...
                            {modelSelectorOpen && (
                                ...
                                >
                                    <div className="py-1">
                                        ...
                                        <div className="my-1 border-t border-gray-200"></div>
                                        <div className="px-3 py-0.5 text-xs text-gray-500">Bạn bè</div>

                                        <motion.button
                                            whileHover={{ backgroundColor: 'rgba(0,0,0,0.1)' }}
                                            className="flex items-center w-full px-3 py-1.5 text-left hover:bg-gray-100 transition-colors duration-150"
                                            onClick={() => {
                                                setSelectedModel("Bạn bè 1");
                                                setModelSelectorOpen(false);
                                            }}
                                        >
                                            Bạn bè 1
                                        ...
                                        <motion.button
                                            whileHover={{ backgroundColor: 'rgba(0,0,0,0.1)' }}
                                            className="flex items-center w-full px-3 py-1.5 text-left text-gray-700 hover:bg-gray-100 transition-colors duration-150"
                                            onClick={() => {
                                                setModelSelectorOpen(false);
